                ...
                <div className="container mx-auto pt-12 px-10 sm:px-6 lg:px-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                        <div className="max-w-lg">
                            ...
                            <div className="flex items-center mb-4">
                                <img src={Confiance} className="h-10 mr-2" alt={Rapidité} title={Rapidité} loading="lazy" />
                        ...
                        <div className="mt-12 md:mt-0">
                            <img src={About} className="object-cover hidden sm:block rounded-lg shadow-md" alt={About} title={About} loading="lazy" />
                        </div>
                    </div>
                </div>
            </section>
