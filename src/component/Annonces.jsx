    ...
    return (
        <>
            <section className="flex flex-col items-center bg-white pb-5">
                    ...
                    <div className="mt-10 grid max-w-md grid-cols-1 gap-6 px-2 sm:max-w-lg sm:px-20 md:max-w-screen-xl md:grid-cols-2 md:px-10 lg:grid-cols-4 lg:gap-8">
                        <article className="mb-4  cursor-pointer  overflow-hidden rounded-xl border text-gray-700 shadow-md duration-500 ease-in-out hover:shadow-xl">
                            <div className="relative">
                                ...
                                <span className="absolute top-0 left-0 m-2 rounded-full bg-[#2db34a] px-2 text-center text-sm font-medium text-white">New</span>
                            </div>
                            <div className="p-4">
                                <div className="pb-6">
                                    <a href="#" className="text-lg hover:text-[#2db34a] font-medium duration-500 ease-in-out">$50000</a> <br />
                                    <a href="#" className=" hover:text-[#2db34a] font-medium duration-500 ease-in-out">238 Baton Rouge, LA 70809, USA</a> <br />
                ...
                <button class="relative mt-4 rounded-lg border-2 border-[#2db34a] w-[16rem] hover:scale-105 bg-[#2db34a]  px-6 py-2 font-medium text-white transition">
                    <div class="-scale-x-100 absolute left-0 -bottom-10 inline-flex h-10 w-10 -rotate-12 text-[#2db34a]">
