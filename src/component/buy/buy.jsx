...
function buy() {
    return (
        <>
            <div class="sm:ml-5 sm:mr-5 ">
                <div class="flex flex-col">
                    <div class="p-6 ">
                        <form class="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">


                            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                <div class="flex flex-col">
                                    <input type="text" id="name" placeholder="Enter your address,city,zip code" class="mt-2 block w-full rounded-md border border-gray-100 bg-gray-100 px-2 py-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
                                </div>
                            ...
                            <div class="mt-6 grid w-full grid-cols-2 justify-end space-x-4 md:flex">
                                ...
                                <button class="rounded-lg bg-[#2db34a] px-8 py-2 font-medium text-white outline-none hover:opacity-80 focus:ring">Search</button>
                            </div>
                        </form>
                    </div>
                </div>
